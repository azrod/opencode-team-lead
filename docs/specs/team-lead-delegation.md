...
| `plan-validator` | Vérificateur structurel des exec-plans — functional_objective, blocs atomiques, critères Done when vérifiables. | subagent | [plan-validator-agent](plan-validator-agent.md) |
