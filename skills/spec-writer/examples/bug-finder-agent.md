...
| Utilisateur / Le team-lead | Un fix a été appliqué mais le problème persiste ou s'est déplacé |
| Le team-lead | Bug détecté — toujours déléguer à `bug-finder` avant tout fix |
