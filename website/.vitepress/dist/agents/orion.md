---
url: 'https://azrod.github.io/opencode-team-lead/agents/orion.md'
---
...
| **CHANGES\_REQUESTED** | Re-delegate fixes to the original producer with review-manager's feedback, then request a second review |
